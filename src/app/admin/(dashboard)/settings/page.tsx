...
export default function SettingsPage() {
  ...
  const [previewTemplate, setPreviewTemplate] = useState<'balance' | 'receipt' | 'portal' | 'weekly' | 'welcome' | null>(null)
  ...
  const getBalanceEmailPreview = () => {
    ...
    const logoUrl = formData.school_logo_url || 'https://www.aldersgatechristian.com/wp-content/uploads/2017/12/ACA-Logo_Horizontal_White_small.png'
  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: white; padding: 32px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
      ...
      <div style="text-align: center; margin-bottom: 28px;">
        <a href="#" style="display: inline-block; background: ${accentColor}; color: white; text-decoration: none; padding: 16px 40px; border-radius: 10px; font-weight: 700; font-size: 16px; box-shadow: 0 4px 14px rgba(0, 177, 193, 0.4);">
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 0; background-color: #f8fafc;">
  ...
  // Generate portal access link email preview HTML
  const getPortalLinkEmailPreview = () => {
    const schoolName = formData.school_name || 'Your School'
    const logoUrl = formData.school_logo_url || 'https://www.aldersgatechristian.com/wp-content/uploads/2017/12/ACA-Logo_Horizontal_White_small.png'
    const primaryColor = formData.primary_color || '#002c5f'
    const accentColor = formData.accent_color || '#00b1c1'
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 0; background-color: #f8fafc;">
  ...
  // Generate weekly summary email preview HTML
  const getWeeklySummaryEmailPreview = () => {
    const schoolName = formData.school_name || 'Your School'
    const logoUrl = formData.school_logo_url || 'https://www.aldersgatechristian.com/wp-content/uploads/2017/12/ACA-Logo_Horizontal_White_small.png'
    const primaryColor = formData.primary_color || '#002c5f'
    const accentColor = formData.accent_color || '#00b1c1'
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 0; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: white; padding: 32px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 28px; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        <thead>
          <tr style="background: linear-gradient(to bottom, #f8fafc 0%, #f1f5f9 100%);">
            <th style="padding: 14px 16px; text-align: left; font-size: 12px; color: #64748b; font-weight: 600; text-transform: uppercase; border-bottom: 1px solid #e2e8f0;">Student</th>
            <th style="padding: 14px 16px; text-align: center; font-size: 12px; color: #64748b; font-weight: 600; text-transform: uppercase; border-bottom: 1px solid #e2e8f0;">Used</th>
            <th style="padding: 14px 16px; text-align: center; font-size: 12px; color: #64748b; font-weight: 600; text-transform: uppercase; border-bottom: 1px solid #e2e8f0;">Added</th>
            <th style="padding: 14px 16px; text-align: right; font-size: 12px; color: #64748b; font-weight: 600; text-transform: uppercase; border-bottom: 1px solid #e2e8f0;">Balance</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td style="padding: 16px; border-bottom: 1px solid #e2e8f0; text-align: center;">
              <span style="color: #dc2626; font-weight: 600;">-4</span>
            </td>
            <td style="padding: 16px; border-bottom: 1px solid #e2e8f0; text-align: center;">
              <span style="color: #22c55e; font-weight: 600;">+10</span>
            </td>
            <td style="padding: 16px; border-bottom: 1px solid #e2e8f0; text-align: right;">
              <div style="display: inline-block; background: #dcfce7; color: #22c55e; padding: 6px 12px; border-radius: 8px; font-weight: 700;">12</div>
            </td>
          </tr>
          <tr>
            <td style="padding: 16px; border-bottom: 1px solid #e2e8f0;">
            ...
            <td style="padding: 16px; border-bottom: 1px solid #e2e8f0; text-align: center;">
              <span style="color: #dc2626; font-weight: 600;">-3</span>
            </td>
            <td style="padding: 16px; border-bottom: 1px solid #e2e8f0; text-align: center;">
              <span style="color: #22c55e; font-weight: 600;">+0</span>
            </td>
            <td style="padding: 16px; border-bottom: 1px solid #e2e8f0; text-align: right;">
              <div style="display: inline-block; background: #fef3c7; color: #f59e0b; padding: 6px 12px; border-radius: 8px; font-weight: 700;">6</div>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div style="text-align: center; padding: 24px;">
      <p style="color: #94a3b8; font-size: 12px; margin: 0;">${schoolName} | Lunch Program</p>
      <p style="color: #cbd5e1; font-size: 11px; margin: 8px 0 0 0;">You're receiving this because weekly summaries are enabled for your account.</p>
    </div>
  </div>
</body>
</html>`
  ...
  // Generate welcome email preview HTML
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 0; background-color: #f8fafc;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: white; padding: 32px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
      ...
      <p style="color: #475569; font-size: 15px; line-height: 1.6; margin: 0 0 24px 0;">
        Your children have been enrolled in the ${schoolName} lunch program. Here's what you need to know:
      </p>
        ...
        <div className="modal-overlay" onClick={() => setPreviewTemplate(null)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <h3>
                {previewTemplate === 'balance' && 'Balance Notification Email'}
                {previewTemplate === 'receipt' && 'Payment Receipt Email'}
                {previewTemplate === 'portal' && 'Portal Access Link Email'}
                {previewTemplate === 'weekly' && 'Weekly Summary Email'}
                {previewTemplate === 'welcome' && 'Welcome Email'}
              </h3>
            ...
            <div className="modal-body">
              ...
              <iframe
                srcDoc={
                  previewTemplate === 'balance' ? getBalanceEmailPreview() :
                  previewTemplate === 'receipt' ? getReceiptEmailPreview() :
                  previewTemplate === 'portal' ? getPortalLinkEmailPreview() :
                  previewTemplate === 'weekly' ? getWeeklySummaryEmailPreview() :
